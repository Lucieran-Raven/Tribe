    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-6 p-8 bg-white rounded-xl shadow-lg">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900">Welcome to Tribe</h1>
          <p className="mt-2 text-gray-600">Your campus. Your people. Your Tribe.</p>
        </div>

        {message && (
          <div className={`p-3 rounded-md text-sm ${message.includes('sent') ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-500'}`}>
            {message}
          </div>
        )}
